...
window.Vuemit = __webpack_require__(8);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Libraries_Autocomplete__ = __webpack_require__(4);
	...
	/* harmony default export */ exports["default"] = {
		...
		mounted: function mounted()
		{
			...
			this.autocomplete = __WEBPACK_IMPORTED_MODULE_0__Libraries_Autocomplete__["a" /* default */].make(this.input_id, this.config);
		},

		watch:
		{
			place: function place$1()
			{
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__googleAutocomplete_vue__ = __webpack_require__(6);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__googleAutocomplete_vue___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_1__googleAutocomplete_vue__);
...
__WEBPACK_IMPORTED_MODULE_0_vue___default.a.component('google-autocomplete', __WEBPACK_IMPORTED_MODULE_1__googleAutocomplete_vue___default.a);
...
var Autocomplete = function Autocomplete(ref, config)
{
...
/**
	 ...
	 * @return Autocomplete
	 */
Autocomplete.make = function make (ref, config)
{
		if ( config === void 0 ) config = {};
...
/**
	 ...
	 * @return {Void}
	 */
Autocomplete.prototype.boot = function boot ()
{
		var this$1 = this;

	__WEBPACK_IMPORTED_MODULE_0__Loader__["a" /* default */].load(function () { return this$1.bind(this$1); });
};
...
/**
	 ...
	 * @param {Self}
	 */
Autocomplete.prototype.bind = function bind (obj)
{
	obj.autocomplete = new google.maps.places.Autocomplete(
		obj.ref, this.config
	);

	    obj.autocomplete.addListener('place_changed', function () { obj.pipe(); });
};
...
/**
	 ...
	 * @return {Void}
	 */
Autocomplete.prototype.pipe = function pipe ()
{
	var data  = {};
...
/**
	 ...
	 * @return {Object}
	 */
Autocomplete.prototype.getResponse = function getResponse ()
{
...
/**
	 ...
	 * @return {Object}
	 */
Autocomplete.prototype.getInstance = function getInstance ()
{
	return this.autocomplete;
};

/* harmony default export */ exports["a"] = Autocomplete;
...
/**
	 ...
	 * @return {Void}
	 */
Loader.load = function load (callback)
{
...
/**
	 ...
	 * @return {String}
	 */
Loader.prototype.source = function source ()
{
...
__vue_options__.__file = "/Users/Gustavo/Documents/VALET/google-autocomplete/src/js/Components/googleAutocomplete.vue"
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-f265e5b8", __vue_options__)
  } else {
    hotAPI.reload("data-v-f265e5b8", __vue_options__)
  }
})()}
if (__vue_options__.functional) {console.error("[vue-loader] googleAutocomplete.vue: functional components are not supported and should be defined in plain js files using render functions.")}
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-f265e5b8", module.exports)
  }
}
...
new Vue({
	...
	methods:
	{
		 ...
		 * @return {Void}
		 */
		onAddressChanged: function onAddressChanged(payload)
		{
